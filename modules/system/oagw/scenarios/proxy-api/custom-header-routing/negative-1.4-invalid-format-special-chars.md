# Invalid X-OAGW-Target-Host format with special characters
...
X-OAGW-Target-Host: us.vendor.com?region=us
...

{
  ...
  "invalid_value": "us.vendor.com?region=us"
}
```

## Validation

- Header must not include query parameters or special characters
- Only valid hostname characters are allowed (alphanumeric, dots, hyphens)
