...
```json
{
  ...
  "action": { "name": "list" },
  "resource": { "type": "gts.cf.core.tasks.task.v1~" },
  "context": {
    "tenant_context": {
      "mode": "subtree",
      "root_id": "T1-uuid",
...
```json
{
  ...
  "action": { "name": "read" },
  "resource": {
    "type": "gts.cf.core.tasks.task.v1~",
    "id": "task456-uuid"
  },
  "context": {
    "tenant_context": {
...
```json
{
  ...
  "action": { "name": "list" },
  "resource": { "type": "gts.cf.core.billing.usage.v1~" },
  "context": {
    "tenant_context": {
      "mode": "subtree",
      "root_id": "T1-uuid",
...
```json
{
  ...
  "context": {
    "deny_reason": {
      ...
      "details": "Subject 'user123-uuid' lacks 'list' permission on 'gts.cf.core.tasks.task.v1~' in tenant 'T1-uuid'"
    }
  }
}
```
